...
#define CONST_PROXY_ACCESS                                                                                                                                                                                                               \
    ...
    operator()(colon_void, colon_void) const { return *this; }                                                                                                                                                                           \
    const idx_cv_i<const expression_type>                                                                                                                                                                                                \
    operator()(colon_void, size_type col) const { return idx_cv_i<const expression_type>(*this, col); }                                                                                                                                  \
    template <typename E9>                                                                                                                                                                                                               \
    const idx_cv_J<const expression_type, E9>                                                                                                                                                                                            \
    operator()(colon_void, const matrix_expression<E9> &col) const { return idx_cv_J<const expression_type, E9>(*this, col()); }                                                                                                         \
    template <typename T8>                                                                                                                                                                                                               \
    const idx_cv_range<const expression_type, const range<T8>>                                                                                                                                                                           \
    operator()(colon_void, const range<T8> &range_col) const { return idx_cv_range<const expression_type, const range<T8>>(*this, range_col); }                                                                                          \
    template <typename T8>                                                                                                                                                                                                               \
    const idx_cv_iv<const expression_type, const interleaved<T8>>                                                                                                                                                                        \
    operator()(colon_void, const interleaved<T8> &interleaved_col) const { return idx_cv_iv<const expression_type, const interleaved<T8>>(*this, interleaved_col); }                                                                     \
                                                                                                                                                                                                                                         \
    const idx_i_cv<const expression_type>                                                                                                                                                                                                \
    operator()(size_type row, colon_void) const { return idx_i_cv<const expression_type>(*this, row); }                                                                                                                                  \
    template <typename E9>                                                                                                                                                                                                               \
    const idx_J_cv<const expression_type, E9>                                                                                                                                                                                            \
    operator()(const matrix_expression<E9> &row, colon_void) const { return idx_J_cv<const expression_type, E9>(*this, row()); }                                                                                                         \
    template <typename T8>                                                                                                                                                                                                               \
    const idx_range_cv<const expression_type, const range<T8>>                                                                                                                                                                           \
    operator()(const range<T8> &range_row, colon_void) const { return idx_range_cv<const expression_type, const range<T8>>(*this, range_row); }                                                                                          \
    template <typename T8>                                                                                                                                                                                                               \
    const idx_iv_cv<const expression_type, const interleaved<T8>>                                                                                                                                                                        \
    operator()(const interleaved<T8> &interleaved_row, colon_void) const { return idx_iv_cv<const expression_type, const interleaved<T8>>(*this, interleaved_row); }                                                                     \
                                                                                                                                                                                                                                         \
    template <typename E9>                                                                                                                                                                                                               \
    const idx_J_i<const expression_type, E9>                                                                                                                                                                                             \
    operator()(const matrix_expression<E9> &row, size_type col) const { return idx_J_i<const expression_type, E9>(*this, row(), col); }                                                                                                  \
    template <typename T8>                                                                                                                                                                                                               \
    const idx_range_i<const expression_type, const range<T8>>                                                                                                                                                                            \
    operator()(const range<T8> &range_row, size_type i) const { return idx_range_i<const expression_type, const range<T8>>(*this, range_row, i); }                                                                                       \
    template <typename T8>                                                                                                                                                                                                               \
    const idx_iv_i<const expression_type, const interleaved<T8>>                                                                                                                                                                         \
    operator()(const interleaved<T8> &interleaved_row, size_type i) const { return idx_iv_i<const expression_type, const interleaved<T8>>(*this, interleaved_row, i); }                                                                  \
    template <typename E9>                                                                                                                                                                                                               \
    const idx_i_J<const expression_type, E9>                                                                                                                                                                                             \
    operator()(size_type row, const matrix_expression<E9> &col) const { return idx_i_J<const expression_type, E9>(*this, row, col()); }                                                                                                  \
    template <typename E8, typename E9>                                                                                                                                                                                                  \
    const idx_J_J<const expression_type, E8, E9>                                                                                                                                                                                         \
    operator()(const matrix_expression<E8> &row, const matrix_expression<E9> &col) const { return idx_J_J<const expression_type, E8, E9>(*this, row(), col()); }                                                                         \
    template <typename T8, typename E8>                                                                                                                                                                                                  \
    const idx_range_J<const expression_type, const range<T8>, E8>                                                                                                                                                                        \
    operator()(const range<T8> &range_row, const matrix_expression<E8> &col) const { return idx_range_J<const expression_type, const range<T8>, E8>(*this, range_row, col()); }                                                          \
    template <typename T8, typename E8>                                                                                                                                                                                                  \
    const idx_iv_J<const expression_type, const interleaved<T8>, E8>                                                                                                                                                                     \
    operator()(const interleaved<T8> &interleaved_row, const matrix_expression<E8> &col) const { return idx_iv_J<const expression_type, const interleaved<T8>, E8>(*this, interleaved_row, col()); }                                     \
    template <typename T8>                                                                                                                                                                                                               \
    const idx_i_range<const expression_type, const range<T8>>                                                                                                                                                                            \
    operator()(size_type i, const range<T8> &range_col) const { return idx_i_range<const expression_type, const range<T8>>(*this, i, range_col); }                                                                                       \
    template <typename E8, typename T8>                                                                                                                                                                                                  \
    const idx_J_range<const expression_type, E8, const range<T8>>                                                                                                                                                                        \
    operator()(const matrix_expression<E8> &row, const range<T8> &range_col) const { return idx_J_range<const expression_type, E8, const range<T8>>(*this, row(), range_col); }                                                          \
    template <typename T8, typename T9>                                                                                                                                                                                                  \
    const idx_range_range<const expression_type, const range<T8>, const range<T9>>                                                                                                                                                       \
    operator()(const range<T8> &range1, const range<T9> &range2) const { return idx_range_range<const expression_type, const range<T8>, const range<T9>>(*this, range1, range2); }                                                       \
    template <typename T8, typename T9>                                                                                                                                                                                                  \
    const idx_iv_range<const expression_type, const interleaved<T8>, const range<T9>>                                                                                                                                                    \
    operator()(const interleaved<T8> &interleaved_row, const range<T9> &range_col) const { return idx_iv_range<const expression_type, const interleaved<T8>, const range<T9>>(*this, interleaved_row, range_col); }                      \
    template <typename T8>                                                                                                                                                                                                               \
    const idx_i_iv<const expression_type, const interleaved<T8>>                                                                                                                                                                         \
    operator()(size_type row, const interleaved<T8> &interleaved_col) const { return idx_i_iv<const expression_type, const interleaved<T8>>(*this, row, interleaved_col); }                                                              \
    template <typename E8, typename T8>                                                                                                                                                                                                  \
    const idx_J_iv<const expression_type, E8, const interleaved<T8>>                                                                                                                                                                     \
    operator()(const matrix_expression<E8> &row, const interleaved<T8> &interleaved_col) const { return idx_J_iv<const expression_type, E8, const interleaved<T8>>(*this, row(), interleaved_col); }                                     \
    template <typename T8, typename T9>                                                                                                                                                                                                  \
    const idx_range_iv<const expression_type, const range<T8>, const interleaved<T9>>                                                                                                                                                    \
    operator()(const range<T8> &range_row, const interleaved<T9> &interleaved_col) const { return idx_range_iv<const expression_type, const range<T8>, const interleaved<T9>>(*this, range_row, interleaved_col); }                      \
    template <typename T8, typename T9>                                                                                                                                                                                                  \
    const idx_iv_iv<const expression_type, const interleaved<T8>, const interleaved<T9>>                                                                                                                                                 \
    operator()(const interleaved<T8> &interleaved_row, const interleaved<T9> &interleaved_col) const { return idx_iv_iv<const expression_type, const interleaved<T8>, const interleaved<T9>>(*this, interleaved_row, interleaved_col); } \
                                                                                                                                                                                                                                         \
    template <typename E9>                                                                                                                                                                                                               \
    const idx_I<const expression_type, E9>                                                                                                                                                                                               \
    operator()(const matrix_expression<E9> &I) const { return idx_I<const expression_type, E9>(*this, I()); }                                                                                                                            \
    const idx_cv<const expression_type>                                                                                                                                                                                                  \
    operator()(colon_void) const { return idx_cv<const expression_type>(*this); }                                                                                                                                                        \
    template <typename T9>                                                                                                                                                                                                               \
    const idx_range<const expression_type, T9>                                                                                                                                                                                           \
    operator()(const range<T9> &range) const { return idx_range<const expression_type, T9>(*this, range); }                                                                                                                              \
    template <typename T9>                                                                                                                                                                                                               \
    const idx_iv<const expression_type, T9>                                                                                                                                                                                              \
    operator()(const interleaved<T9> &interleaved) const { return idx_iv<const expression_type, T9>(*this, interleaved); }

#define NON_CONST_PROXY_ACCESS                                                                                                                                                                                               \
                                                                                                                                                                                                                             \
    expression_type &                                                                                                                                                                                                        \
    operator()(colon_void, colon_void) { return *this; }                                                                                                                                                                     \
    idx_cv_i<expression_type>                                                                                                                                                                                                \
    operator()(colon_void, size_type col) { return idx_cv_i<expression_type>(*this, col); }                                                                                                                                  \
    template <typename E9>                                                                                                                                                                                                   \
    idx_cv_J<expression_type, E9>                                                                                                                                                                                            \
    operator()(colon_void, const matrix_expression<E9> &col) { return idx_cv_J<expression_type, E9>(*this, col()); }                                                                                                         \
    template <typename T8>                                                                                                                                                                                                   \
    idx_cv_range<expression_type, const range<T8>>                                                                                                                                                                           \
    operator()(colon_void, const range<T8> &range_col) { return idx_cv_range<expression_type, const range<T8>>(*this, range_col); }                                                                                          \
    template <typename T8>                                                                                                                                                                                                   \
    idx_cv_iv<expression_type, const interleaved<T8>>                                                                                                                                                                        \
    operator()(colon_void, const interleaved<T8> &interleaved_col) { return idx_cv_iv<expression_type, const interleaved<T8>>(*this, interleaved_col); }                                                                     \
                                                                                                                                                                                                                             \
    idx_i_cv<expression_type>                                                                                                                                                                                                \
    operator()(size_type row, colon_void) { return idx_i_cv<expression_type>(*this, row); }                                                                                                                                  \
    template <typename E9>                                                                                                                                                                                                   \
    idx_J_cv<expression_type, E9>                                                                                                                                                                                            \
    operator()(const matrix_expression<E9> &row, colon_void) { return idx_J_cv<expression_type, E9>(*this, row()); }                                                                                                         \
    template <typename T8>                                                                                                                                                                                                   \
    idx_range_cv<expression_type, const range<T8>>                                                                                                                                                                           \
    operator()(const range<T8> &range_row, colon_void) { return idx_range_cv<expression_type, const range<T8>>(*this, range_row); }                                                                                          \
    template <typename T8>                                                                                                                                                                                                   \
    idx_iv_cv<expression_type, const interleaved<T8>>                                                                                                                                                                        \
    operator()(const interleaved<T8> &inter_row, colon_void) { return idx_iv_cv<expression_type, const interleaved<T8>>(*this, inter_row); }                                                                                 \
                                                                                                                                                                                                                             \
    template <typename E9>                                                                                                                                                                                                   \
    idx_J_i<expression_type, E9>                                                                                                                                                                                             \
    operator()(const matrix_expression<E9> &row, size_type col) { return idx_J_i<expression_type, E9>(*this, row(), col); }                                                                                                  \
    template <typename T8>                                                                                                                                                                                                   \
    idx_range_i<expression_type, const range<T8>>                                                                                                                                                                            \
    operator()(const range<T8> &range_row, size_type i) { return idx_range_i<expression_type, const range<T8>>(*this, range_row, i); }                                                                                       \
    template <typename T8>                                                                                                                                                                                                   \
    idx_iv_i<expression_type, const interleaved<T8>>                                                                                                                                                                         \
    operator()(const interleaved<T8> &interleaved_row, size_type i) { return idx_iv_i<expression_type, const interleaved<T8>>(*this, interleaved_row, i); }                                                                  \
    template <typename E9>                                                                                                                                                                                                   \
    idx_i_J<expression_type, E9>                                                                                                                                                                                             \
    operator()(size_type row, const matrix_expression<E9> &col) { return idx_i_J<expression_type, E9>(*this, row, col()); }                                                                                                  \
    template <typename E8, typename E9>                                                                                                                                                                                      \
    idx_J_J<expression_type, E8, E9>                                                                                                                                                                                         \
    operator()(const matrix_expression<E8> &row, const matrix_expression<E9> &col) { return idx_J_J<expression_type, E8, E9>(*this, row(), col()); }                                                                         \
    template <typename T8, typename E8>                                                                                                                                                                                      \
    idx_range_J<expression_type, const range<T8>, E8>                                                                                                                                                                        \
    operator()(const range<T8> &range_row, const matrix_expression<E8> &col) { return idx_range_J<expression_type, const range<T8>, E8>(*this, range_row, col()); }                                                          \
    template <typename T8, typename E8>                                                                                                                                                                                      \
    idx_iv_J<expression_type, const interleaved<T8>, E8>                                                                                                                                                                     \
    operator()(const interleaved<T8> &interleaved_row, const matrix_expression<E8> &col) { return idx_iv_J<expression_type, const interleaved<T8>, E8>(*this, interleaved_row, col()); }                                     \
    template <typename T8>                                                                                                                                                                                                   \
    idx_i_range<expression_type, const range<T8>>                                                                                                                                                                            \
    operator()(size_type i, const range<T8> &range_col) { return idx_i_range<expression_type, const range<T8>>(*this, i, range_col); }                                                                                       \
    template <typename E8, typename T8>                                                                                                                                                                                      \
    idx_J_range<expression_type, E8, const range<T8>>                                                                                                                                                                        \
    operator()(const matrix_expression<E8> &row, const range<T8> &range_col) { return idx_J_range<expression_type, E8, const range<T8>>(*this, row(), range_col); }                                                          \
    template <typename T8, typename T9>                                                                                                                                                                                      \
    idx_range_range<expression_type, const range<T8>, const range<T9>>                                                                                                                                                       \
    operator()(const range<T8> &range1, const range<T9> &range2) { return idx_range_range<expression_type, const range<T8>, const range<T9>>(*this, range1, range2); }                                                       \
    template <typename T8, typename T9>                                                                                                                                                                                      \
    idx_iv_range<expression_type, const interleaved<T8>, const range<T9>>                                                                                                                                                    \
    operator()(const interleaved<T8> &interleaved_row, const range<T9> &range_col) { return idx_iv_range<expression_type, const interleaved<T8>, const range<T9>>(*this, interleaved_row, range_col); }                      \
    template <typename T8>                                                                                                                                                                                                   \
    idx_i_iv<expression_type, const interleaved<T8>>                                                                                                                                                                         \
    operator()(size_type row, const interleaved<T8> &interleaved_col) { return idx_i_iv<expression_type, const interleaved<T8>>(*this, row, interleaved_col); }                                                              \
    template <typename E8, typename T8>                                                                                                                                                                                      \
    idx_J_iv<expression_type, E8, const interleaved<T8>>                                                                                                                                                                     \
    operator()(const matrix_expression<E8> &row, const interleaved<T8> &interleaved_col) { return idx_J_iv<expression_type, E8, const interleaved<T8>>(*this, row(), interleaved_col); }                                     \
    template <typename T8, typename T9>                                                                                                                                                                                      \
    idx_range_iv<expression_type, const range<T8>, const interleaved<T9>>                                                                                                                                                    \
    operator()(const range<T8> &range_row, const interleaved<T9> &interleaved_col) { return idx_range_iv<expression_type, const range<T8>, const interleaved<T9>>(*this, range_row, interleaved_col); }                      \
    template <typename T8, typename T9>                                                                                                                                                                                      \
    idx_iv_iv<expression_type, const interleaved<T8>, const interleaved<T9>>                                                                                                                                                 \
    operator()(const interleaved<T8> &interleaved_row, const interleaved<T9> &interleaved_col) { return idx_iv_iv<expression_type, const interleaved<T8>, const interleaved<T9>>(*this, interleaved_row, interleaved_col); } \
                                                                                                                                                                                                                             \
    template <typename E9>                                                                                                                                                                                                   \
    idx_I<expression_type, E9>                                                                                                                                                                                               \
    operator()(const matrix_expression<E9> &I) { return idx_I<expression_type, E9>(*this, I()); }                                                                                                                            \
    idx_cv<expression_type>                                                                                                                                                                                                  \
    operator()(colon_void) { return idx_cv<expression_type>(*this); }                                                                                                                                                        \
    template <typename T1>                                                                                                                                                                                                   \
    idx_range<expression_type, T1>                                                                                                                                                                                           \
    operator()(const range<T1> &range) { return idx_range<expression_type, T1>(*this, range); }                                                                                                                              \
    template <typename T1>                                                                                                                                                                                                   \
    idx_iv<expression_type, T1>                                                                                                                                                                                              \
    operator()(const interleaved<T1> &interleaved) { return idx_iv<expression_type, T1>(*this, interleaved); }
